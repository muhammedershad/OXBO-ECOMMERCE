...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Set the selected gender when the page loads
    ...
    // // Trigger the change event on the selected gender radio button
    // const selectedGenderRadio = document.querySelector('input[name="gender"]:checked');
    // if (selectedGenderRadio) {
    //     selectedGenderRadio.dispatchEvent(new Event('change'));
    // }
    ...
    fetch(`/admin/productCategories?gender=${gender}`)
            ...
            .then(data => {
                ...
                data.categories.forEach((category,index) => {
                    ...
                    forSubCategory(categoryId,productId)
                });
            })
            .catch(error => {
                console.error('Error fetching categories:', error);
